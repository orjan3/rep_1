# Code of conduct for `rep_1`

Contributors to this repository hosted by `orjan3` are expected to follow the
...
- "Project", we mean this `rep_1` GitHub repository;
- "Maintainer", we mean the `orjan3` organisation owners; and
- "Leadership", we mean both `orjan3` organisation owners, line managers, and other
  leadership within the UPC.
...
[elheazar3@gmail.com][email-address]. All complaints will be
...
[email-address]: mailto:elheazar3@gmail.com

...
Desarrollo de espectros de energía empleando registros de terremotos ocurridos en Perú, y la comparación de la energía que aporta al daño con los espectros de velocidades de la E.030
...
```shell
python src/rep_1/run_pipeline.py
```
...
[If you want to help us build, and improve `rep_1`, view our
